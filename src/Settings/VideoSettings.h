...
public:
    ...
    DEFINE_SETTINGFACT(rtspBroadcastUrl)
    ...
    Q_PROPERTY(QString  rtspBroadcastVideo      READ rtspBroadcastVideo     CONSTANT)
    ...
    QString  rtspBroadcastVideo     () { return videoBroadcastRTSP; }
    ...
    static constexpr const char* videoBroadcastRTSP           = QT_TRANSLATE_NOOP("VideoSettings", "RTSP Broadcast Video Stream");
